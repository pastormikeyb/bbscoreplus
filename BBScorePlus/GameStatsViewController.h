...
//    IBOutlet UITableView *tableView;
    ...
    NSMutableArray *loadedDoubleHit, *loadedTripleHit,*loadedHomeRun, *loadedFieldersChoice, *loadedHitByPitch, *loadedSacFly, *loadedFieldingError, *loadedRbi, *loadedWalk, *loadedPutOut;
    ...
    NSMutableArray *loadedOpponentFieldingError, *loadedOpponentRbi, *loadedOpponentWalk, *loadedOpponentPutOut;
