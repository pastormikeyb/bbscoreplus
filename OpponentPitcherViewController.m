...
#import "OpponentPitcherViewController.h"

@interface OpponentPitcherViewController ()
{
    NSString *playerBat;
...
@implementation OpponentPitcherViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView2 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    OpponentPitcherTableViewCell *customCell2 = [tableView2 dequeueReusableCellWithIdentifier:lineupTableID];
    
    if (customCell2 == nil) {
        customCell2 = [[OpponentPitcherTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:lineupTableID];
    }
    ...
    switch (button.tag) {
        case 0:
            NSLog(@"Done button");
                ...
                //Save
            NSLog(@"Save button");
            NSLog(@"myTeamDictionaryArray: %@",opponentDictionaryArray);
            [self saveInfo];
            [self showAlert];
...
- (void)showAlert {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Opponent Pitcher"
